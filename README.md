...
- [x] __CI/CD__: [Gitlab](https://docs.gitlab.com/ee/ci/)
- [x] __Unix__: Installation and configuration of web platforms from scratch. _[openlitespeed](https://openlitespeed.org/), [nginx](https://nginx.org/), multiply [php](https://php.net/) versions, cronjobs, databases([pgsql](https://www.postgresql.org/), [mysql](https://www.mysql.com/))_

### Was a mentor & teacher in
- [Atom Space](https://atomspace.od.ua)
- [IT2School](https://it2school.od.ua)
